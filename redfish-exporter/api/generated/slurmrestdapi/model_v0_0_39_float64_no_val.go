...
// checks if the V0039Float64NoVal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0039Float64NoVal{}
...
func (o V0039Float64NoVal) MarshalJSON() ([]byte, error) {
...
func (o V0039Float64NoVal) ToMap() (map[string]interface{}, error) {
...
type NullableV0039Float64NoVal struct {
	value *V0039Float64NoVal
	isSet bool
}
...
func NewNullableV0039Float64NoVal(val *V0039Float64NoVal) *NullableV0039Float64NoVal {
	return &NullableV0039Float64NoVal{value: val, isSet: true}
}
