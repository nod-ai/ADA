...
// checks if the V0041JobInfoMsgInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobInfoMsgInner{}

// V0041JobInfoMsgInner struct for V0041JobInfoMsgInner
type V0041JobInfoMsgInner struct {
...
// SetAccrueTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the AccrueTime field.
...
// SetArrayJobId gets a reference to the given V0041Uint32NoValStruct and assigns it to the ArrayJobId field.
...
// SetArrayTaskId gets a reference to the given V0041Uint32NoValStruct and assigns it to the ArrayTaskId field.
...
// SetArrayMaxTasks gets a reference to the given V0041Uint32NoValStruct and assigns it to the ArrayMaxTasks field.
...
// SetCoresPerSocket gets a reference to the given V0041Uint16NoValStruct and assigns it to the CoresPerSocket field.
...
// SetBillableTres gets a reference to the given V0041Float64NoValStruct and assigns it to the BillableTres field.
...
// SetCpusPerTask gets a reference to the given V0041Uint16NoValStruct and assigns it to the CpusPerTask field.
...
// SetCpuFrequencyMinimum gets a reference to the given V0041Uint32NoValStruct and assigns it to the CpuFrequencyMinimum field.
...
// SetCpuFrequencyMaximum gets a reference to the given V0041Uint32NoValStruct and assigns it to the CpuFrequencyMaximum field.
...
// SetCpuFrequencyGovernor gets a reference to the given V0041Uint32NoValStruct and assigns it to the CpuFrequencyGovernor field.
...
// SetDeadline gets a reference to the given V0041Uint64NoValStruct and assigns it to the Deadline field.
...
// SetDelayBoot gets a reference to the given V0041Uint32NoValStruct and assigns it to the DelayBoot field.
...
func (o *V0041JobInfoMsgInner) GetDerivedExitCode() V0041ProcessExitCodeVerbose {
	if o == nil || IsNil(o.DerivedExitCode) {
		var ret V0041ProcessExitCodeVerbose
		return ret
	}
...
// SetDerivedExitCode gets a reference to the given V0041ProcessExitCodeVerbose and assigns it to the DerivedExitCode field.
...
// SetEligibleTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the EligibleTime field.
...
// SetExitCode gets a reference to the given V0041ProcessExitCodeVerbose and assigns it to the ExitCode field.
...
// SetHetJobId gets a reference to the given V0041Uint32NoValStruct and assigns it to the HetJobId field.
...
// SetHetJobOffset gets a reference to the given V0041Uint32NoValStruct and assigns it to the HetJobOffset field.
...
// SetJobResources gets a reference to the given V0041JobRes and assigns it to the JobResources field.
...
// SetLastSchedEvaluation gets a reference to the given V0041Uint64NoValStruct and assigns it to the LastSchedEvaluation field.
...
// SetMaxCpus gets a reference to the given V0041Uint32NoValStruct and assigns it to the MaxCpus field.
...
// SetMaxNodes gets a reference to the given V0041Uint32NoValStruct and assigns it to the MaxNodes field.
...
// SetTasksPerCore gets a reference to the given V0041Uint16NoValStruct and assigns it to the TasksPerCore field.
...
// SetTasksPerTres gets a reference to the given V0041Uint16NoValStruct and assigns it to the TasksPerTres field.
...
// SetTasksPerNode gets a reference to the given V0041Uint16NoValStruct and assigns it to the TasksPerNode field.
...
// SetTasksPerSocket gets a reference to the given V0041Uint16NoValStruct and assigns it to the TasksPerSocket field.
...
// SetTasksPerBoard gets a reference to the given V0041Uint16NoValStruct and assigns it to the TasksPerBoard field.
...
// SetCpus gets a reference to the given V0041Uint32NoValStruct and assigns it to the Cpus field.
...
// SetNodeCount gets a reference to the given V0041Uint32NoValStruct and assigns it to the NodeCount field.
...
// SetTasks gets a reference to the given V0041Uint32NoValStruct and assigns it to the Tasks field.
...
// SetMinimumCpusPerNode gets a reference to the given V0041Uint16NoValStruct and assigns it to the MinimumCpusPerNode field.
...
// SetMinimumTmpDiskPerNode gets a reference to the given V0041Uint32NoValStruct and assigns it to the MinimumTmpDiskPerNode field.
...
// SetPreemptTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the PreemptTime field.
...
// SetPreemptableTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the PreemptableTime field.
...
// SetPreSusTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the PreSusTime field.
...
// SetResizeTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the ResizeTime field.
...
// SetSocketsPerNode gets a reference to the given V0041Uint16NoValStruct and assigns it to the SocketsPerNode field.
...
// SetSubmitTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the SubmitTime field.
...
// SetSuspendTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the SuspendTime field.
...
// SetThreadsPerCore gets a reference to the given V0041Uint16NoValStruct and assigns it to the ThreadsPerCore field.
...
func (o V0041JobInfoMsgInner) MarshalJSON() ([]byte, error) {
...
func (o V0041JobInfoMsgInner) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobInfoMsgInner struct {
	value *V0041JobInfoMsgInner
	isSet bool
}

func (v NullableV0041JobInfoMsgInner) Get() *V0041JobInfoMsgInner {
	return v.value
}

func (v *NullableV0041JobInfoMsgInner) Set(val *V0041JobInfoMsgInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobInfoMsgInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobInfoMsgInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobInfoMsgInner(val *V0041JobInfoMsgInner) *NullableV0041JobInfoMsgInner {
	return &NullableV0041JobInfoMsgInner{value: val, isSet: true}
}

func (v NullableV0041JobInfoMsgInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobInfoMsgInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
