...
// checks if the V0041OpenapiMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiMeta{}

// V0041OpenapiMeta struct for V0041OpenapiMeta
...
func (o V0041OpenapiMeta) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiMeta) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiMeta struct {
	value *V0041OpenapiMeta
	isSet bool
}

func (v NullableV0041OpenapiMeta) Get() *V0041OpenapiMeta {
	return v.value
}

func (v *NullableV0041OpenapiMeta) Set(val *V0041OpenapiMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiMeta(val *V0041OpenapiMeta) *NullableV0041OpenapiMeta {
	return &NullableV0041OpenapiMeta{value: val, isSet: true}
}

func (v NullableV0041OpenapiMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
