...
// checks if the V0041CronEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041CronEntry{}

// V0041CronEntry struct for V0041CronEntry
...
func (o V0041CronEntry) MarshalJSON() ([]byte, error) {
...
func (o V0041CronEntry) ToMap() (map[string]interface{}, error) {
...
type NullableV0041CronEntry struct {
	value *V0041CronEntry
	isSet bool
}

func (v NullableV0041CronEntry) Get() *V0041CronEntry {
	return v.value
}

func (v *NullableV0041CronEntry) Set(val *V0041CronEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041CronEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041CronEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041CronEntry(val *V0041CronEntry) *NullableV0041CronEntry {
	return &NullableV0041CronEntry{value: val, isSet: true}
}

func (v NullableV0041CronEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041CronEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
