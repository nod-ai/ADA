...
// checks if the V0041Float64NoValStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041Float64NoValStruct{}

// V0041Float64NoValStruct struct for V0041Float64NoValStruct
...
func (o V0041Float64NoValStruct) MarshalJSON() ([]byte, error) {
...
func (o V0041Float64NoValStruct) ToMap() (map[string]interface{}, error) {
...
type NullableV0041Float64NoValStruct struct {
	value *V0041Float64NoValStruct
	isSet bool
}

func (v NullableV0041Float64NoValStruct) Get() *V0041Float64NoValStruct {
	return v.value
}

func (v *NullableV0041Float64NoValStruct) Set(val *V0041Float64NoValStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041Float64NoValStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041Float64NoValStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041Float64NoValStruct(val *V0041Float64NoValStruct) *NullableV0041Float64NoValStruct {
	return &NullableV0041Float64NoValStruct{value: val, isSet: true}
}

func (v NullableV0041Float64NoValStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041Float64NoValStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
