...
// checks if the V0039Uint64NoVal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0039Uint64NoVal{}
...
func (o V0039Uint64NoVal) MarshalJSON() ([]byte, error) {
...
func (o V0039Uint64NoVal) ToMap() (map[string]interface{}, error) {
...
type NullableV0039Uint64NoVal struct {
	value *V0039Uint64NoVal
	isSet bool
}
...
func NewNullableV0039Uint64NoVal(val *V0039Uint64NoVal) *NullableV0039Uint64NoVal {
	return &NullableV0039Uint64NoVal{value: val, isSet: true}
}
