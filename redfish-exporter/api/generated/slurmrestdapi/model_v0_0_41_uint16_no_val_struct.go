...
// checks if the V0041Uint16NoValStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041Uint16NoValStruct{}

// V0041Uint16NoValStruct struct for V0041Uint16NoValStruct
...
func (o V0041Uint16NoValStruct) MarshalJSON() ([]byte, error) {
...
func (o V0041Uint16NoValStruct) ToMap() (map[string]interface{}, error) {
...
type NullableV0041Uint16NoValStruct struct {
	value *V0041Uint16NoValStruct
	isSet bool
}

func (v NullableV0041Uint16NoValStruct) Get() *V0041Uint16NoValStruct {
	return v.value
}

func (v *NullableV0041Uint16NoValStruct) Set(val *V0041Uint16NoValStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041Uint16NoValStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041Uint16NoValStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041Uint16NoValStruct(val *V0041Uint16NoValStruct) *NullableV0041Uint16NoValStruct {
	return &NullableV0041Uint16NoValStruct{value: val, isSet: true}
}

func (v NullableV0041Uint16NoValStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041Uint16NoValStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
