...
// checks if the V0041NodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041NodesInner{}

// V0041NodesInner struct for V0041NodesInner
type V0041NodesInner struct {
	...
	ExternalSensors           *V0041ExtSensorsData    `json:"external_sensors,omitempty"`
	Extra                     *string                 `json:"extra,omitempty"`
	Power                     *V0041PowerMgmtData     `json:"power,omitempty"`
...
// SetBootTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the BootTime field.
...
// SetFreeMem gets a reference to the given V0041Uint64NoValStruct and assigns it to the FreeMem field.
...
// SetEnergy gets a reference to the given V0041AcctGatherEnergy and assigns it to the Energy field.
...
// SetExternalSensors gets a reference to the given V0041ExtSensorsData and assigns it to the ExternalSensors field.
...
// SetPower gets a reference to the given V0041PowerMgmtData and assigns it to the Power field.
...
// SetLastBusy gets a reference to the given V0041Uint64NoValStruct and assigns it to the LastBusy field.
...
// SetReasonChangedAt gets a reference to the given V0041Uint64NoValStruct and assigns it to the ReasonChangedAt field.
...
// SetResumeAfter gets a reference to the given V0041Uint64NoValStruct and assigns it to the ResumeAfter field.
...
// SetSlurmdStartTime gets a reference to the given V0041Uint64NoValStruct and assigns it to the SlurmdStartTime field.
...
func (o V0041NodesInner) MarshalJSON() ([]byte, error) {
...
func (o V0041NodesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV0041NodesInner struct {
	value *V0041NodesInner
	isSet bool
}

func (v NullableV0041NodesInner) Get() *V0041NodesInner {
	return v.value
}

func (v *NullableV0041NodesInner) Set(val *V0041NodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041NodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041NodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041NodesInner(val *V0041NodesInner) *NullableV0041NodesInner {
	return &NullableV0041NodesInner{value: val, isSet: true}
}

func (v NullableV0041NodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041NodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
