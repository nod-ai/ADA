...
// checks if the V0039Uint32NoVal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0039Uint32NoVal{}
...
func (o V0039Uint32NoVal) MarshalJSON() ([]byte, error) {
...
func (o V0039Uint32NoVal) ToMap() (map[string]interface{}, error) {
...
type NullableV0039Uint32NoVal struct {
	value *V0039Uint32NoVal
	isSet bool
}
...
func NewNullableV0039Uint32NoVal(val *V0039Uint32NoVal) *NullableV0039Uint32NoVal {
	return &NullableV0039Uint32NoVal{value: val, isSet: true}
}
