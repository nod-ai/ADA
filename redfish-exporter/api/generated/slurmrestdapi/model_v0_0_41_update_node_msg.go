...
// checks if the V0041UpdateNodeMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041UpdateNodeMsg{}
...
// SetResumeAfter gets a reference to the given V0041Uint32NoValStruct and assigns it to the ResumeAfter field.
...
// SetWeight gets a reference to the given V0041Uint32NoValStruct and assigns it to the Weight field.
...
func (o V0041UpdateNodeMsg) ToMap() (map[string]interface{}, error) {
