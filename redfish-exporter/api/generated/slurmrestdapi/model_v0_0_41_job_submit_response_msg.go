...
// checks if the V0041JobSubmitResponseMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobSubmitResponseMsg{}

// V0041JobSubmitResponseMsg struct for V0041JobSubmitResponseMsg
...
func NewV0041JobSubmitResponseMsg() *V0041JobSubmitResponseMsg {
	this := V0041JobSubmitResponseMsg{}
	return &this
}
...
func (o V0041JobSubmitResponseMsg) MarshalJSON() ([]byte, error) {
...
func (o V0041JobSubmitResponseMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobSubmitResponseMsg struct {
	value *V0041JobSubmitResponseMsg
	isSet bool
}

func (v NullableV0041JobSubmitResponseMsg) Get() *V0041JobSubmitResponseMsg {
	return v.value
}

func (v *NullableV0041JobSubmitResponseMsg) Set(val *V0041JobSubmitResponseMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobSubmitResponseMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobSubmitResponseMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobSubmitResponseMsg(val *V0041JobSubmitResponseMsg) *NullableV0041JobSubmitResponseMsg {
	return &NullableV0041JobSubmitResponseMsg{value: val, isSet: true}
}

func (v NullableV0041JobSubmitResponseMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobSubmitResponseMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
